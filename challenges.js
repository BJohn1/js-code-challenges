...
function formatWithPadding(int,str,int1) {
  var output=""
  if(int.toString().length>int1){
    return int.toString()
  }
  for(let i=0;i<(int1-int.toString().length);i++){
    output=output+str
  }
  output=output+int
  return output
...
function isPalindrome(str) {
  ...
  if(rev.toUpperCase()===str1.toUpperCase()){
...
function intersection(arr,list){
 let ans=[]
